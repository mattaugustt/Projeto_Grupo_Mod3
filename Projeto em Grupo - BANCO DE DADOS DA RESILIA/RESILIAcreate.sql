...
-- Feito por Lenilson #alinhado com RESILIALogic #checkDK
CREATE TABLE aluno(
...
-- Feito por Davi #Feito Alterações #checkDK
...
--Feito por Douglas #Foi feito alterações #checkDK
...
-- Feito por Matheus #Foi feito alterações #checkDK
